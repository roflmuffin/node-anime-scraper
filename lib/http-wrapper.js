...
var BlockedError, InvalidCFCookieError, InvalidUserAgentError, KissCookie, KissHTTP, MaxRetryError, Promise, _, cheerio, cloudscraper, debug, got,
...
BlockedError = (function(superClass) {
  ...
  function BlockedError(reason, body) {
    ...
    this.message = "You have been blocked, the page states:  " + reason;
