...
(function() {
  var CaptchaBlockedError, InvalidCFCookieError, InvalidUserAgentError, KissCookie, KissHTTP, MaxRetryError, Promise, _, cloudscraper, debug, got,
  ...
  CaptchaBlockedError = (function(superClass) {
    extend(CaptchaBlockedError, superClass);

    function CaptchaBlockedError() {
      this.name = 'CaptchaBlockedError';
      this.message = 'You have made requests too rapidly and have been CAPTCHA blocked.';
    ...
    KissHTTP.prototype.getFreshCookie = function() {
      ...
      return new Promise((function(_this) {
        return function(resolve, reject) {
          return cloudscraper.get('https://kissanime.to', function(err, resp) {
            if (err) {
